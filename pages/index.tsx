...
export default function Home() {
  return (
    <div>
      ...
      <div className="w-4/5 m-auto cursor-pointer bg-white mt-[-42px] rounded-tl-[1.875rem] min-h-[21.5rem] p-6 md:p-14 flex flex-wrap-reverse justify-around">
        ...
        <div className='w-[35.625rem] max-h-80'>
          <img src={"https://patriciaelias.com.br/wp-content/uploads/2021/01/placeholder.png"} alt="Thumbnail" className='w-full h-full object-cover rounded-[1.25rem] hover:opacity-90' />
        </div>
      </div>
